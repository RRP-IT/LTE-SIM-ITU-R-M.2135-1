...
EnbLtePhy::EnbLtePhy()
{
  ...
  //SetTxPower(42.2778); //dBm Anderson
  //SetTxPower(42.7762); //dBm @ 5GHz
  //SetTxPower(42.2478); //dBm @ 3.5GHz para mim 42.2478 dBm
  SetTxPower(40); //dBm @ 2.6GHz para mim 40 dBm
  //SetTxPower(46.6953); //dBm @ 5.62GHz RP  5.62 GHz 46.6953 dBm
}
